...
import AboutHeroImageMobile from '../assets/helen_manente_about_hero_mobile.jpg'
...
function AboutHero() {
    return(
        <>
            ...
            <h1 className="sr-only">About Helen Manente Yoga</h1>
            <picture>
        <source srcSet={AboutHeroImageMobile} media="(max-width: 768px)" />
